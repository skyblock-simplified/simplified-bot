...
import dev.sbs.bot.processor.resource.ResourceCollectionsProcessor;
import dev.sbs.bot.processor.resource.ResourceItemsProcessor;
import dev.sbs.bot.processor.resource.ResourceSkillsProcessor;
import dev.sbs.bot.util.ItemCache;
        ...
        DiscordConfig discordConfig = DiscordConfig.builder()
            ...
            .withCommands(
                Reflection.getResources()
                    .filterPackage("dev.sbs.bot.command")
